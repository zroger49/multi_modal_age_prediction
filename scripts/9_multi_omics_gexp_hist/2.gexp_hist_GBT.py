...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('9.1_hist_gexp_GBT_LDS.log'),
    ]
)
...
for tissue in tissues_to_run:
    ...
    study.trials_dataframe().to_csv(f"results/9.multi_modal_models_gexp_hist/{tissue}/2_optuna_table.csv")
    ...
    with mlflow.start_run(run_name = tissue + "_GBT_multi_modal_gexp_hist", experiment_id = EXPERIMENT_ID) as _:
        ...
        train_prediction.to_csv(f"results/9.multi_modal_models_gexp_hist/{tissue}/2_hist_gexp_GBT_en_train_prediction.csv")
        ...
        test_prediction.to_csv(f"results/9.multi_modal_models_gexp_hist/{tissue}/2_hist_gexp_GBT_en_test_prediction.csv")
        ...
        plot_model_fit(y_train, 
                        y_train_pred, 
                        data_set="Train", 
                        fig_output_path= f"aging_notes/figures/9.multi_modal_models_gexp_hist/2_{tissue}_GBT_hist_gexp_fit_train.pdf")


        plot_model_fit(y_test, 
                    y_test_pred, 
                    data_set="Test", 
                    fig_output_path= f"aging_notes/figures/9.multi_modal_models_gexp_hist/2_{tissue}_GBT_hist_gexp_fit_test.pdf")
        ...
        model_coef.to_csv(f"results/9.multi_modal_models_gexp_hist/{tissue}/12_EN_hist_gexp_feature_importance.csv")

        # Save model 
        joblib.dump(pipe, f'results/9.multi_modal_models_gexp_hist/{tissue}/12_EN_hist_gexp.pipeline.pkl', compress = 1)
